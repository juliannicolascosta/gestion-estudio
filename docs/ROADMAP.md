...
- [ ] Completar la separación de `app.py` en paneles y controladores; los componentes de compilación, los paneles de archivos/acceso rápido y los diálogos de configuración y SISFE ya fueron extraídos sin cambiar el flujo probado.
